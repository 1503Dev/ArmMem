...
public:
    ...
    static std::vector<MemoryValue> searchQword(int pid, long long value, const std::vector<MemoryValue>& prevList);
    static std::vector<MemoryValue> searchByte(int pid, signed char value, const std::vector<MemoryValue>& prevList);
    static std::vector<MemoryValue> searchWord(int pid, short wordValue, const std::vector<MemoryValue>& prevList);
    ...
    static std::vector<MemoryValue> searchQword(int pid, long long value, const std::vector<uintptr_t>& prevAddrList);
    static std::vector<MemoryValue> searchByte(int pid, signed char value, const std::vector<uintptr_t>& prevAddrList);
    static std::vector<MemoryValue> searchWord(int pid, short wordValue, const std::vector<uintptr_t>& prevAddrList);
    ...
    static std::vector<MemoryValue> searchQword(long long value, const std::vector<MemoryValue>& prevList);
    static std::vector<MemoryValue> searchByte(signed char value, const std::vector<MemoryValue>& prevList);
    static std::vector<MemoryValue> searchWord(short wordValue, const std::vector<MemoryValue>& prevList);
